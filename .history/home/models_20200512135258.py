...
class Books_purchased (models.Model):
    ...
    user1 = models.ForeignKey(to_field=User.USERNAME_FIELD,verbose_name="userSold")
    user2 = models.ForeignKey(to_field=User.USERNAME_FIELD,verbose_name="userPurcahsed")
