...
class Books_purchased (models.Model):
    ...
    user1 = models.ForeignKey(to=User,to_field=User.username,verbose_name="User Sold",on_delete=models.DO_NOTHING)
    user2 = models.ForeignKey(to=User, to_field=User.username,verbose_name="User Purchased", on_delete=models.DO_NOTHING)
